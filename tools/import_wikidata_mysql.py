...
def main():
    ...
    with open(csv_path, mode='r') as csv_file:
        ...
        for row in csv_reader:
            ...
            params = (authorid, row['item'], row['labels'], row['awards'], row['birthday'], row['countries'], row['educations'], row['employers'], row['fieldofworks'], row['google'], row['img'], row['occupations'], row['twitter'], row['website'])
